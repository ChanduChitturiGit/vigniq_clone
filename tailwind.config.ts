	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'bounce-subtle': 'bounce-subtle 0.7s ease-out forwards',
			...
			boxShadow: {
				...
				'medium': '0 8px 30px -5px rgba(0, 0, 0, 0.12), 0 4px 15px -3px rgba(0, 0, 0, 0.06)',
				'strong': '0 15px 50px -10px rgba(0, 0, 0, 0.18), 0 5px 20px -5px rgba(0, 0, 0, 0.08)',
